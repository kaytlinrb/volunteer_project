...
describe(Volunteer) do
  describe("#initialize") do
    it("is initialized with title and author") do
      volunteer1 = Volunteer.new({:name => "Quincy", :id => nil})
  ...
  describe ('.find') do
    it("returns a volunteer by its id number") do
      volunteer1 = Volunteer.new({:name => "Quincy", :id => nil})
      volunteer1.save()
      volunteer2 = Volunteer.new({:name => "Rowan", :id => nil})
      volunteer2.save()
      expect(Volunteer.find(volunteer2.id())).to(eq(volunteer2))
    end
  end
  describe("#update_this") do
    it("lets you assign new values to an entry") do
      volunteer1 = Volunteer.new({:name => "Quincy", :id => nil})
      volunteer1.save()
      volunteer1.update_this({:name => "Sierra", :id => nil})
  ...
  #     volunteer1 = Volunteer.new({:name => "Quincy", :id => nil})
  #     volunteer1.save()
  #     volunteer2 = Volunteer.new({:name => "Quincy", :id => nil})
  #     volunteer2.save()
